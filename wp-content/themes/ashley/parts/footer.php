<!-- footer -->
    ...
    <!-- fancybox js -->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/plugins/fancybox.min.js"></script>
    <!-- gsap js -->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/plugins/gsap.min.js"></script>
    <!-- scroll smoother -->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/plugins/smooth-scroll.js"></script>
    <!-- scroll trigger js -->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/plugins/ScrollTrigger.min.js"></script>
    <!-- scroll to js -->
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/plugins/ScrollTo.min.js"></script>
    <!-- ashley js -->
